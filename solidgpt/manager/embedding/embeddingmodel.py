...
class EmbeddingModelParameter:
    def __init__(self, resource_name: str, original_resources_folder_path: str, divided_resources_folder_path: str, embedded_resources_folder_path: str, is_embedded: bool = False):
...
class EmbeddingModel:
    def __init__(self, param : EmbeddingModelParameter):
        ...
        self.is_embedded = param.is_embedded
