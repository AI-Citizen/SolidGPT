...
import logging
from solidgpt.src.constants import SKILL_NAME_SUMMARY_CODE
...
from solidgpt.src.util.util import load_from_text
...
class SummaryCode(WorkSkill):
    ...
    def __init__(self):
        super().__init__()
        self.name = SKILL_NAME_SUMMARY_CODE
