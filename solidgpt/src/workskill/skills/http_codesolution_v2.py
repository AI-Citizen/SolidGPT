...
class HTTPCodeSolutionV2(WorkSkill):
    # Graph Cache Label
    CODE_PLAN = "code_plan"
    ...
    def __init__(self):
        ...
        self.name = SKILL_NAME_HTTP_SOLUTION_V2
    ...
    def __build_writting_code_prompt(self):
        return """
                ...
                1. Implement the code for the {Requirement}, follow the {Code Plan} to implement the final code solution.
