...
from solidgpt.manager.promptresource import CUSTOM_GENERATE_LIST_SKILLS_OUTPUT_FORMAT, CUSTOM_GENERATE_PRINCIPLES, CUSTOM_GENERATE_SKILL_JSON_OUTPUT_FORMAT, CUSTOM_GENERATE_SKILL_JSON_ROLE_ASSUMPTION, build_gpt_prompt, get_custom_skills_assumption_role_prompt
